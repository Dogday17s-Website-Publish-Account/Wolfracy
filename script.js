// Neon PostgreSQL setup - using REST API approach
const NEON_API_URL = 'https://neon-bronze-candle-04903213.us-east-1.aws.neon.tech';
const NEON_API_KEY = 'npg_3H4R1Tm1q2Kj';
...
async function loadData() {
    try {
        ...
        // Load requests
        const requestsData = await executeQuery('SELECT requests');
        console.log('Requests data:', requestsData);
        requests = requestsData;

        // Load messages
        const messagesData = await executeQuery('SELECT messages');
        console.log('Messages data:', messagesData);
        messages = messagesData;

        // Load public messages
        const publicMessagesData = await executeQuery('SELECT public_messages');
